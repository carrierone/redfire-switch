...
fn test_autocorrelation() {
    ...
    println!("     r[2] = {:.3}", r[2]);
    println!(
        "   ✓ Autocorrelation property (r[0] ≥ r[1]): {}",
        r[0] >= r[1]
    );
...
fn test_levinson_durbin() {
    ...
    let r = [
        100.0, 50.0, 25.0, 12.5, 6.25, 3.125, 1.5625, 0.78125, 0.390625, 0.1953125, 0.09765625,
    ];
...
fn performance_comparison() {
    ...
    println!(
        ...
        if cfg!(feature = "g729_asm") {
            ...
            "Assembly disabled (fallback mode)"
        }
    );
}
